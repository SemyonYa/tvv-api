...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 13 2021 г., 23:23
...
(60, 'Text', 'Балахониха — посёлок в Арзамасском районе Нижегородской области. Располагается в 35 км к северу от Арзамаса.', 1, 0),
(61, 'Text', 'Основан в 1909 году при строительстве железнодорожной ветки Муром-Арзамас.', 1, 1),
(62, 'Text', 'В конце 1950-х – начале 1960-х гг. в 2 км от поселка построена нефтеперекачивающая станция нефтепровода Альметьевск – Котово – Рязань с рабочей силой в 120 человек.  Поселок при нефтеперекачивающей станции вошел в состав поселка Балахониха. ', 1, 2),
(63, 'Text', 'В настоящее время в поселке Балахониха проживают 820 человек. Из них около 180 человек детей и молодежи.', 1, 3),
(64, 'H2', 'Основные рабочие места: ', 1, 4),
(65, 'List', 'ж/д (50 чел.), \nстанция Арзамас-2 (30 чел.), \nНПС «Балахониха» (79 чел.), \nсоциальная сфера.', 1, 5),
(66, 'Text', 'посёлок городского типа Павловского муниципального района Нижегородской области, имеющего статус городского поселения.  ', 3, 0),
(67, 'Text', 'Численность населения — 6 855 чел.', 3, 1),
(68, 'Text', 'Одно из градообразующих предприятий района — нефтеперекачивающая станция (НПС) «Степаньково» Горьковского районного нефтепроводного управления АО «Транснефть-Верхняя Волга».', 3, 2),
(69, 'Text', 'село в Лысковском районе Нижегородской области, административный центр Валковского сельсовета. Численность населения — 722 человека. Одно из градообразующих предприятий района — нефтеперекачивающая станция (НПС)  «Макарьево» Марийского районного нефтепроводного управления АО «Транснефть — Верхняя Волга».', 4, 0),
(70, 'Text', 'посёлок городского типа в Нижегородской области, административный центр Воротынского муниципального района. Образует городское поселение рабочий посёлок Воротынец. ', 5, 0),
(71, 'Text', 'Численность населения - 7177 чел.', 5, 1),
(72, 'Text', 'Одно из градообразующих предприятий поселка — линейно-производственно-диспетчерская станция (ЛПДС) \"Воротынец\" Марийского районного нефтепроводного управления АО «Транснефть-Верхняя Волга».', 5, 2);
...
(1, 'Балахониха', NULL, 1, 'Нижегородская область', 336.6, 378.1179138322),
(2, 'Кстово', NULL, 1, 'Нижегородская область', 347.36666666667, 401.36054421769),
(3, 'Тумботино', NULL, 1, 'Нижегородская область', 438.6, 354.87528344671),
(4, 'Валки', NULL, 1, 'Нижегородская область', 329.23333333333, 439.90929705215),
(5, 'Воротынец', NULL, 1, 'Нижегородская область', 282.2, 408.73015873016),
(6, 'Ермишь', NULL, 1, 'Рязанская область', 182.46666666667, 379.81859410431),
(7, 'Мосолово', NULL, 1, 'Рязанская область', 234.6, 412.13151927438),
...
(20, 'Великие Луки', NULL, 1, 'Псковская область', 59.5, 119.04761904762);
